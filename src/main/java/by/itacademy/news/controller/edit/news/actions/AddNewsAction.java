    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (permissionsChecker.isWritePermission(role)) {
                ...
                if (!contentChecker.isEmpty(title, brief, content, date, time, imagePart.getSubmittedFileName())) {
                    ...
                    newsService.addNews(title, brief, content, openPath, paramParser.parseDate(date, time));
            ...
            doResponse(response, ParameterType.ERROR.getParameter(),
                    OutputMessage.INC_DATE_FORMAT.getMessage(), PathType.ADD_PAGE.getPath());
        }
    }
